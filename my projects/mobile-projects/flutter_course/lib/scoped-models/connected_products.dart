...
mixin ProductsModel on ConnectedProductModel {
  ...
  Future<bool> addProduct(String title, String description, File image,
    ...
    try {
      final http.Response response = await http.post(
          'https://flutterproduct-85e7e.firebaseio.com/products.json?auth=${_authenticatedUser.token}',
  ...
  Future<bool> updateProduct(String title, String description, File image,
    ...
    try {
      await http.put(
          'https://flutterproduct-85e7e.firebaseio.com/products/${selectedProduct.id}.json?auth=${_authenticatedUser.token}',
  ...
  Future<bool> deleteProduct() {
    ...
    return http
        .delete(
            'https://flutterproduct-85e7e.firebaseio.com/products/$deletedProductId.json?auth=${_authenticatedUser.token}')
  ...
  void toggleProductFavoriteStatus(Product toggledProduct) async {
    ...
    if (newFavoriteStatus) {
      response = await http.put(
          'https://flutterproduct-85e7e.firebaseio.com/products/${toggledProduct.id}/wishlistUsers/${_authenticatedUser.id}.json?auth=${_authenticatedUser.token}',
  ...
  Future<Map<String, dynamic>> authenticate(String email, String password,
    ...
    if (mode == AuthMode.Login) {
      response = await http.post(
          'https://www.googleapis.com/identitytoolkit/v3/relyingparty/verifyPassword?key=AIzaSyAOXvnucS7sgxpFSNi7SbhbAp2gSzNLVkY',
          body: json.encode(authData),
          headers: {'Content-Type': 'application/json'});
    } else {
      response = await http.post(
        'https://www.googleapis.com/identitytoolkit/v3/relyingparty/signupNewUser?key=AIzaSyAOXvnucS7sgxpFSNi7SbhbAp2gSzNLVkY',
        body: json.encode(authData),
        headers: {'Content-Type': 'application/json'},
      );
    }
